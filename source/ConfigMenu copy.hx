				...
				switch(configSelected){
					case 0: //Offset
						...
						if(FlxG.keys.justPressed.ENTER){
							...
							Config.write(offsetValue, accuracyType, healthValue / 10.0, healthDrainValue / 10.0, iconValue, downValue, inputValue, randomTapValue, cutsceneValue, disableDodgeSoundValue);
